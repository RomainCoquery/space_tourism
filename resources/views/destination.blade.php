...
<body class="page destination">
    ...
    <div class="planet_body">
        ...
        <div class="planet_picture">
                <img id="moon_picture" class="active" src="{{ asset('img/moon.png') }}" alt="Lune">
                <img id="mars_picture" class="hidden" src="{{ asset('img/mars.png') }}" alt="Mars">
                <img id="europe_picture" class="hidden" src="{{ asset('img/europe.png') }}" alt="Europe">
                <img id="titan_picture" class="hidden" src="{{ asset('img/titan.png') }}" alt="Titan">
            </div>
        ...
        <div class="planet_content">
            ...
            <div class="navbar">
                <nav class="nav_bar_planet navigation">
                    <ul class="nav_bar_planet_list ">
                        <li><button class="button active navigation" onclick="showContent('moon')">Lune</button></li>
                        <li><button class="button hidden navigation" onclick="showContent('mars')">Mars</button></li>
                        <li><button class="button hidden navigation" onclick="showContent('europe')">Europe</button></li>
                        <li><button class="button hidden navigation" onclick="showContent('titan')">Titan</button></li>
                    </ul>
                </nav>
            </div>

            <!-- Contenu de la lune -->
            <div id="moon_content" class="planet_description active">
            ...
            <!-- Contenu de mars -->
            <div id="mars_content" class="planet_description hidden">
            ...
            <!-- Contenu d'europe -->
            <div id="europe_content" class="planet_description hidden">
            ...
            <!-- Contenu de titan -->
            <div id="titan_content" class="planet_description hidden">
