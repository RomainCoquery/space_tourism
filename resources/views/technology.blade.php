...
<body class="page technology">
    ...
    <div class="crew_body main">
        ...
        <div class="technology_content">
            ...
            <!-- Contenu de douglas -->
            <div data-name="douglas" class="technology_description description active">
            ...
            <div data-name="shuttleworth" class="technology_description description hidden">
            ...
            <!-- Contenu de glover -->
            <div data-name="glover" class="technology_description description hidden">
            ...
            <!-- Contenu d'ansari -->
            <div data-name="ansari" class="technology_description description hidden">
