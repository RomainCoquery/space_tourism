...
<body class="page crew">
    ...
    <div class="crew_body main">
        ...
        <!-- Contenu de douglas -->
        <div data-crew="douglas" class="crew_description description active">
        ...
        <div data-crew="shuttleworth" class="crew_description description hidden">
        ...
        <!-- Contenu de glover -->
        <div data-crew="glover" class="crew_description description hidden">
        ...
        <!-- Contenu d'ansari -->
        <div data-crew="ansari" class="crew_description description hidden">
        ...
        <div class="navbar">
            <nav class="nav_bar_crew navigation">
                <ul class="nav_bar_crew_list ">
                    <li><button class="button active navigation" data-crew="douglas">&bull;</button></li>
                    <li><button class="button hidden navigation" data-crew="shuttleworth">&bull;</button></li>
                    <li><button class="button hidden navigation" data-crew="glover">&bull;</button></li>
                    <li><button class="button hidden navigation" data-crew="ansari">&bull;</button></li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <div class="crew_content">
        ...
        <div class="crew_picture picture">
            <img data-crew="douglas" class="active" src="{{ asset('img/douglas.png') }}" alt="Douglas">
            <img data-crew="shuttleworth" class="hidden" src="{{ asset('img/shuttleworth.png') }}" alt="Shuttleworth">
            <img data-crew="glover" class="hidden" src="{{ asset('img/glover.png') }}" alt="Glover">
            <img data-crew="ansari" class="hidden" src="{{ asset('img/ansari.png') }}" alt="Ansari">
        </div>
    </div>
</body>
</html>